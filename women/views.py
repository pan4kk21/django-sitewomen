...
posts = [
    {'title': 'Марго Робби', 'content': '''<h1>Анджелина Джоли</h1> (англ. Angelina Jolie[7], при рождении Войт
    ...
    Обладательница премии «Оскар», трёх премий «Золотой глобус» (первая актриса в истории, три года подряд выигравшая
     премию) и двух «Премий Гильдии киноактёров США».''', 'is_published': True, 'id': 3},
    {'title': 'Райан Гослинг', 'content': 'Биография Райана Гослинга', 'is_published': True, 'id': 2}
]
